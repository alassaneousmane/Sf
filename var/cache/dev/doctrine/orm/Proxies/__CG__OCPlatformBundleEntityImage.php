...
class Image extends \OC\PlatformBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'advert', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'tempFilename', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Image' . "\0" . 'title'];
        }
